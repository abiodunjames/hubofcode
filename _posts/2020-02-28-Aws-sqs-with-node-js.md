...
If you ever feel a need to look at the source code, you'll find it [here](https://github.com/abiodunjames/AWS-SQS-Node-Js).
...
If you use the short polling option, your application receives a response immediately, even if the response is empty.
