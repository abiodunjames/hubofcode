...
The HR onboarding is usually generalized and may not include engineering onboarding. As a result, the focus of this post will be on onboarding from the standpoint of a hiring manager.
...
The importance of feedback cannot be overestimated and it is well captured in this [post](https://leadership.garden/onboarding-engineers/).

> _New hires will need frequent feedback to feel safe in their onboarding and understand if they are doing things right. This is both important for their self-confidence, lowers their stress levels, and makes sure they are indeed in the right direction._
