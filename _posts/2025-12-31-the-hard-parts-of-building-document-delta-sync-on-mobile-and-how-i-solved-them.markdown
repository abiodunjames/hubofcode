...
During this holiday, I built document auto-sync with Google Drive and iCloud for my personal hobby project — [Keeplys](https://keeplys.com). This blog post details my approach and the considerations I made.
